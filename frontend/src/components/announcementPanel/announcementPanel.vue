...
export default {
  ...
  data() {
    return {
      ...
      announcementTitle: "Ogłoszenie 1",
      ...
      announcementCategory: "Poszukiwanie sponsora",
      ...
      announcementAuthor: "Jan Kowalski",

      beforeEditAnnouncementDate: "12.08.2022 21:21",
      announcementDate: "12.08.2022 21:21",
  ...
  methods: {
    ...
    cancelAnnouncementCategory() {
      this.announcementCategory = this.beforeEditAnnouncementCategory;
      this.changeAnnouncementCategory();
    },
    ...
    cancelAnnouncementTitle() {
      this.announcementTitle = this.beforeEditAnnouncementTitle;
      this.changeAnnouncementTitle();
    },
    ...
    cancelAnnouncementContent() {
      this.announcementContent = this.beforeEditAnnouncementContent;
      this.changeAnnouncementContent();
    }
  },
