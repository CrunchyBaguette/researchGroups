...
def get_announcement_email(
    userTo: str, userFrom: User, message: str, announcementName: str, link: str
...
def get_email_body_for_announcement(userFrom: User, message: str, announcementName: str, link: str) -> str:
    return f"Od: {userFrom['first_name']} {userFrom['last_name']} ({userFrom['email']})\n\nOgłoszenie:\n{announcementName}\n{link}\n\n{message}"
